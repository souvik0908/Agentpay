import { InvalidUserOperationError, SmartAccountWithSignerRequiredError, deepHexlify, isSmartAccountWithSigner, isValidRequest, resolveProperties, } from "@aa-sdk/core";
import {} from "viem";
...
export const multisigSignatureMiddleware = async (struct, { account, client, context }) => {
    ...
    if (context?.signatures?.length == null &&
