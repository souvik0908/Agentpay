 ...
 * @category API
 */
export declare function deriveSmartAccountIndex(appId: number): bigint;
/**
 ...
 * @category API
 */
export declare function deriveAgentAddress(publicClient: any, userControllerAddress: string, appId: number): Promise<string>;
/**
 ...
 * @category Internal
 */
export declare function createContract({ signer, contractAddress, }: {
    signer: Signer;
 ...
 */
export declare function findEventByName(contract: Contract, logs: {
    topics: Array<string>;
    data: string;
}[], eventName: string): {
    topics: Array<string>;
...
export declare function gasAdjustedOverrides(contract: Contract, methodName: string, args: unknown[], overrides?: Overrides): Promise<Overrides>;
export declare function decodeContractError(error: any, contract: Contract): string;
