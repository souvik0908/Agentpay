export declare const KernelV3_3AccountAbi: readonly [{
    ...
    readonly type: "function";
    readonly name: "changeRootValidator";
    readonly inputs: readonly [{
    ...
    readonly type: "function";
    readonly name: "replayableUserOpHash";
    readonly inputs: readonly [{
        readonly name: "userOp";
        readonly type: "tuple";
        readonly internalType: "struct PackedUserOperation";
    ...
    readonly type: "error";
    readonly name: "InvalidSelectorData";
    readonly inputs: readonly [];
}, {
    readonly type: "error";
