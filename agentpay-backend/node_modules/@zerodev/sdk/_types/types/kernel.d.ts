...
export type KernelPluginManager<entryPointVersion extends EntryPointVersion> = KernelValidator & {
    ...
    getPluginEnableSignature(accountAddress: Address, regularValidator?: KernelValidator): Promise<Hex>;
    ...
    getPluginsEnableTypedData: (accountAddress: Address, regularValidator?: KernelValidator) => Promise<Parameters<CustomSource["signTypedData"]>[0]>;
    isPluginEnabled: (accountAddress: Address, selector: Hex, regularValidator?: KernelValidator) => Promise<boolean>;
