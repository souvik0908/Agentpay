...
exports.deriveSmartAccountIndex = deriveSmartAccountIndex;
exports.deriveAgentAddress = deriveAgentAddress;
exports.createContract = createContract;
exports.findEventByName = findEventByName;
exports.gasAdjustedOverrides = gasAdjustedOverrides;
 ...
 * @category API
 */
function deriveSmartAccountIndex(appId) {
    const prefix = ethers_1.ethers.utils.toUtf8Bytes('vincent_app_id_');
    const appIdBytes = ethers_1.ethers.utils.zeroPad(ethers_1.ethers.utils.hexlify(appId), 5); // uint40 = 5 bytes
    const packed = ethers_1.ethers.utils.concat([prefix, appIdBytes]);
    const hash = ethers_1.ethers.utils.keccak256(packed);
    return BigInt(hash);
}
/**
 ...
 * @category API
 */
async function deriveAgentAddress(publicClient, userControllerAddress, appId) {
    return (0, ecdsa_validator_1.getKernelAddressFromECDSA)({
        publicClient,
        eoaAddress: userControllerAddress,
        index: deriveSmartAccountIndex(appId),
        entryPoint: sdk_1.constants.getEntryPoint('0.7'),
        kernelVersion: sdk_1.constants.KERNEL_V3_3,
    });
}
/**
