...
export type LitNodeClientConfigWithDefaults = Required<Pick<LitNodeClientConfig, 'alertWhenUnauthorized' | 'debug' | 'connectTimeout' | 'checkNodeAttestation' | 'litNetwork' | 'minNodeCount'>> & Partial<Pick<LitNodeClientConfig, 'storageProvider' | 'contractContext' | 'rpcUrl' | 'logFormat' | 'serviceName'>> & {
    bootstrapUrls: string[];
} & {
    nodeProtocol?: typeof HTTP | typeof HTTPS | null;
};
export declare class LitCore extends EventEmitter {
