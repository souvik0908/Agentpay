export declare const IPluginManagerAbi: readonly [{
    ...
    readonly type: "event";
    readonly name: "PluginIgnoredHookUnapplyCallbackFailure";
    readonly inputs: readonly [{
        readonly name: "plugin";
        readonly type: "address";
    ...
    readonly type: "event";
    readonly name: "PluginIgnoredUninstallCallbackFailure";
    readonly inputs: readonly [{
        readonly name: "plugin";
        readonly type: "address";
        readonly indexed: true;
    ...
    readonly inputs: readonly [{
        ...
        readonly name: "callbacksSucceeded";
        readonly type: "bool";
        readonly indexed: true;
